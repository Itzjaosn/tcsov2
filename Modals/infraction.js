...
module.exports = {
  ...
  execute: async function (interaction, client, args) {
    if (args?.[0] === "editstatement") {
      ...
      return interaction.editReply({ content: "<:technical:1472674913054888181> Statement has been updated." });
    }
    ...
    if (infraction.voided) {
      return interaction.editReply({ content: "This infraction has already been voided." });
    }
    ...
    await interaction.editReply({ content: "<:technical:1472674913054888181> Infraction has been voided." });
  },
};
