...
const config = {
  ...
  // Cache
  // add a redis url when you want shared cache. empty = local memory cache
  REDIS_URL: asStr(process.env.REDIS_URL, ""),
  CACHE_REDIS: asBool(process.env.CACHE_REDIS, true),
  CACHE_LOGGING: asBool(process.env.CACHE_LOGGING, true),
  CACHE_PREFIX: asStr(process.env.CACHE_PREFIX, "handler"),
  CACHE_TTL: asNum(process.env.CACHE_TTL, 60),
  CACHE_MAX_ITEMS: asNum(process.env.CACHE_MAX_ITEMS, 5000),
  CACHE_CLEAN_MS: asNum(process.env.CACHE_CLEAN_MS, 30000),
  ...
  HOT_RELOAD: asBool(process.env.HOT_RELOAD, true),
  ...
  // Transcripts
  TRANSCRIPT_PORT:     asNum(process.env.TRANSCRIPT_PORT, 3000),
  TRANSCRIPT_BASE_URL: asStr(process.env.TRANSCRIPT_BASE_URL, "http://localhost:3000"),
  COOKIE_API_KEY:      asStr(process.env.COOKIE_API_KEY, ""),
};
